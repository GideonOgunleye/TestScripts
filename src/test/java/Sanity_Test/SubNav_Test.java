...
public class SubNav_Test extends DriverLoad {
  ...
  public void SymantecLink_Test() {
	  ...
	  NavigationElements.ClickSynmantecLink();
	  
	  if (driver.getTitle().contains("Symantec SSL Certificates")) {
  ...
  public void VerSign_Link_Test() {
	  
	 test = report.startTest("Nav Links Test --> VeriSign Link Test");
	  NavigationElements.ClickVeriSignLink();
	  
	  if (driver.getTitle().contains("VeriSign SSL Certificates")) {
